...
const MovieCard = ({ item }: MovieCardProps) => {
    ...
    return (
        <div className='group bg-zinc-900 col-span relative z-50' >
            ...
            <div className='opacity-0 absolute top-0 transition duration-200 z-10 invisible sm:visible delay-300 w-full scale-0 group-hover:scale-100 md:group-hover:-translate-y-[5vw] group-hover:opacity-100'>
                <Image
                    src={ORIGINAL_IMG_BASE_URL + item?.backdrop_path}
