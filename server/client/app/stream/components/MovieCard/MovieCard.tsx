...
const MovieCard = ({ data }: MovieCardProps) => {
    return (
        <div className='group bg-zinc-900 col-span relative z-50'>
            <Image src='/images/thumbnail.jpg' height={200} width={200} alt='thumbnail' loading={'lazy'} className='cursor-pointer object-cover transition duration shadow-xl rounded-md group-hover:opacity-90 sm:group-hover:opacity-0 delay-300 w-full ' />
            ...
            >
                <Image src='/images/thumbnail.jpg' height={200} width={200} alt='thumbnail' className='cursor-pointer object-cover transition duration shadow-xl rounded-t-md w-full' />
