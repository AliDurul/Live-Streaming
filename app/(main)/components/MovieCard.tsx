...
const MovieCard = ({ movieList }: MovieCardProps) => {
    return (
        <div className='group bg-zinc-900 col-span relative h-[12vw]'>
            ...
            <div className='opacity-0 absolute top-0 transition duration-200 z-10 invisible sm:visible delay-300 w-full scale-0 group-hover:scale-110 group-hover:-translate-y-[3vw] group-hover:translate-x-[2vw] group-hover:opacity-100'>
                ...
                <div className=' z-10 bg-zinc-800 p-2 lg:p-4 absolute w-full transition  shadow-md rounded-b-md '>
                    <div className='flex flex-row items-center gap-3'>
                        ...
                        <div className='cursor-pointer group/item w-6 h-6 lg:w-10 lg:h-10 border-white border-2 rounded-full grid justify-items-center transition hover:border-neutral-300'>
                    ...
                    <div className="flex flex-wrap mt-4 gap-2 items-center justify-between">
                        ...
                        <div className="text-white text-[10px] lg:text-sm">Action</div>
                    </div>
                </div>
            </div>
